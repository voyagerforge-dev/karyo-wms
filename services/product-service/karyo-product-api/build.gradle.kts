...
dependencies {
    ...
    // Patchable<T> tri-state wrapper (UpdateProductRequest, D2)
    implementation(project(":libs:karyo-common"))
    // @JsonInclude(NON_EMPTY) on the Patchable<String>/<Long> properties (jackson-annotations
    // only; no databind needed here).
