...
/**
 * Integration test (REAL beans) for the [OrderProgressionPort] in-process write seam: seeds and
 * releases an order, then advances it to PICKED via the SPI and verifies the new state through REST.
 */
@QuarkusTest
class OrderProgressionPortTest {
